...
def simple_dual_link_shared_switch():
    ...
    # Wi-Fi 
    sta1.cmd('tc qdisc add dev sta1-eth1 root handle 1: tbf rate 60mbit burst 32kbit latency 100ms')
    sta1.cmd('tc qdisc add dev sta1-eth1 parent 1:1 handle 10: netem delay 10ms 3ms distribution normal loss 0.5%')
